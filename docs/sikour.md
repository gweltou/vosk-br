...
{% include embed-audio.html name="10" src="utts/ar_spern_gwenn_gant_laurent_cf68d8d1-a454-428b-9336-bcfe21271192_seg112.mp3" %}
...
{% include embed-audio.html name="15" src="utts/ybd_nozvezh_kentañ_ma_eured_seg117.mp3" %}

`Kerent hi oa parlanti na he ne parlante ket kar {?} me soñj din deus i gouel an eured`

---

{% include embed-audio.html name="18" src="utts/ybd_nozvezh_kentañ_ma_eured_seg120.mp3" %}

`Na hi da joeñtañ he daou dorn na da sell {?} petra bremañ ma Doue me m'oa bevet dilec'h`

---

{% include embed-audio.html name="20" src="utts/ybd_nozvezh_kentañ_ma_eured_seg122.mp3" %}

`me soñje din oan intañvez, ha {?} bout din daou bried, ha bremañ ne goaran gant peseurt mont da gousket`

---

{% include embed-audio.html name="22" src="utts/ybd_nozvezh_kentañ_ma_eured_seg124.mp3" %}
...
{% include embed-audio.html name="79" src="utts/rann4_seg181.mp3" %}
...
{% include embed-audio.html name="80" src="utts/rann4_seg182.mp3" %}
...
{% include embed-audio.html name="84" src="utts/rann4_seg186.mp3" %}

`{?} ... bennaket re yaouank... Ya met se zo partout forz penaos heñ. Hmm. Partout eo... ba Rostronen, ba Karaez eo memes mod heñ.`

---

{% include embed-audio.html name="90" src="utts/rann4_seg192.mp3" %}

`Kêr Hamon, ya. Kêr Hamon zo daou breton met euh {?}dei pe Sant-Jili araves{?}. Ah ya ? Hag a re all zo Gallaoued ?`

---

{% include embed-audio.html name="107" src="utts/rann4_seg209.mp3" %}

`Oh ya, yaouankoc'h evitañ bout oaran ket ped... ah ya ? Ped vloaz oa, tost ... {?}`

---

{% include embed-audio.html name="130" src="utts/rann4_seg232.mp3" %}

`He zad ? Ya. N'eus {?}, amañ soñj din, b'an ti mañ`

---

{% include embed-audio.html name="142" src="utts/rann4_seg244.mp3" %}

`{?} Sant-Jili, Sant Konan, Kanuhel, Korle...`

---

{% include embed-audio.html name="158" src="utts/rann4_seg260.mp3" %}

`ar martolod voe ur paotr fin, ha han arev{?} un doare, na aet da gaout e voereb kozh oh barzh ur gambr a-gostez`

---

{% include embed-audio.html name="164" src="utts/rann4_seg266.mp3" %}

`Kerent hi oa parlanti na he ne parlante ket kar {?} me soñj din deus i gouel an eured`

---

{% include embed-audio.html name="171" src="utts/rann4_seg273.mp3" %}

`Dont a rez c'hwi kamalad c'heomp hon daou d'an hent pras {?} piv o varioneta`

---

{% include embed-audio.html name="176" src="utts/rann4_seg278.mp3" %}

`{?}Per be m'uzemp an droas e kanemp dalc'h mat da dañsal aze kwa, hmm`

---

{% include embed-audio.html name="184" src="utts/rann4_seg286.mp3" %}

`{?} bet ken met unan ba Korle. Ah ya, un zo ba Korle ? Unan zo ba Korle c'hoazh. Ya *pe peseurt anv n'eus ?`

---

{% include embed-audio.html name="186" src="utts/rann4_seg288.mp3" %}

`*{?} {?}`

---

{% include embed-audio.html name="196" src="utts/rann4_seg298.mp3" %}

`Met, c'hwi ouie brezhoneg... galleg euh pa oc'h bet bar skol evit euh... oac'h {?}`

---

{% include embed-audio.html name="197" src="utts/rann4_seg299.mp3" %}

`Pa oan {?} oaren ket ur mot a vije galleg.`

---

{% include embed-audio.html name="200" src="utts/rann4_seg302.mp3" %}

`{?} mestrez skol {?}. Ah ya ? Hi oa deus ar vro ?`

---

{% include embed-audio.html name="202" src="utts/rann4_seg304.mp3" %}

`Ah ya ? Ah gout a ouie brezhoneg neuze ? Oh vije marved {?}`

---

{% include embed-audio.html name="203" src="utts/rann4_seg305.mp3" %}

`An div goarent ket petra oa baraiñ{?}. Ya ?`

---

{% include embed-audio.html name="206" src="utts/rann4_seg308.mp3" %}

`{?} dalc'h mat {?} etre an daou skol. Ah ya ?`

---

{% include embed-audio.html name="207" src="utts/rann4_seg309.mp3" %}
...
{% include embed-audio.html name="209" src="utts/rann4_seg311.mp3" %}

`Peogwir {?} oa re bell mont d'ar skol`

---

{% include embed-audio.html name="218" src="utts/rann4_seg320.mp3" %}

`Un tamm penn anoñ{?} c'hoazh.`

---

{% include embed-audio.html name="220" src="utts/rann4_seg322.mp3" %}

`Pozioù. Emaon da gan d'am non{?} c'hoazh`

---

{% include embed-audio.html name="247" src="utts/rann4_seg349.mp3" %}

`Nann {?}. Ya met euh...`

---

{% include embed-audio.html name="252" src="utts/rann4_seg354.mp3" %}

`{?} kamalad.`

---

{% include embed-audio.html name="254" src="utts/rann4_seg356.mp3" %}

`{?} a gomañse un dañs ha neuze teuent tout an dud barzh.`

---

{% include embed-audio.html name="255" src="utts/rann4_seg357.mp3" %}

`Dañs-dro memes tra. Ya ya. Dañs-dro {?}`

---

{% include embed-audio.html name="262" src="utts/rann4_seg364.mp3" %}

`Oh ya ya ya ya, ya ya ya vije ket {?} komañse un all.`

---

{% include embed-audio.html name="264" src="utts/rann4_seg366.mp3" %}

`{?} munut kwa. Met`

---

{% include embed-audio.html name="265" src="utts/rann4_seg367.mp3" %}

`Pez a rae ar {?}`

---

{% include embed-audio.html name="266" src="utts/rann4_seg368.mp3" %}

`{?}. Ya. Pa vezemp {?} da gano.`

---

{% include embed-audio.html name="268" src="utts/rann4_seg370.mp3" %}
...
{% include embed-audio.html name="269" src="utts/rann4_seg371.mp3" %}

`tre Sant Konan vezent ket kontant {?} Amañ emañ an dalc'h kwa. Gwarizi, jalouzi etre...`

---

{% include embed-audio.html name="277" src="utts/rann4_seg379.mp3" %}

`{?} ket ur bern, nann. {?}`

---

{% include embed-audio.html name="279" src="utts/rann4_seg381.mp3" %}
